...
contract Order {
  ...
  function Order(address _buyer, address _seller, string _name, string _serialNumber, uint256 _timestamp, uint _warrantyMilliseconds1, uint _warrantyMilliseconds2, uint _status, uint _amount) public {
    buyer = _buyer;
    seller = _seller;
    name = _name;
